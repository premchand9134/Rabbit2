    ...
    <footer className="border-t py-12"> 
        <div className=' container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <p className='text-gray-500 mb-4'>Be the first to hear about Products, exclusive events, and online  offers.</p>
                <p className=' font-medium text-sm text-gray-600 mb-6'>Sign up  and get 10% off on your first order. </p>

                {/* News letter form  */}
                <form className='flex '>
                    <input type="email" placeholder='Enter your email' className='border-t border-b border-l border-gray-300 text-sm  rounded-l-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all ' required />  
            ...
            <div>
                ...
                <div className='flex items-center space-x-4 mb-6'>
                    <a href="http://www.facebook.com" target='_blank'  className='hover:text-gray-300'>
                        <TbBrandMeta className='h-5 w-5 ' />
                    </a>
                    <a href="http://www.instagram.com" target='_blank'  className='hover:text-gray-300'>
        ...
        <div className=' container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6  '>
            <p className='text-gray-500 text-sm tracking-tighter text-center '>©️ 2025, Premchand. All Rights Reserved.</p>
        </div>
    </footer>
  )
}
